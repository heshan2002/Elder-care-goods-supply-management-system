...
export const donation = <i className ="fa-solid fa-earth-americas"></i>
//export const stocks = <i className="fa-solid fa-arrow-trend-up"></i>
export const suplier = <i className="fa-solid fa-arrow-trend-up"></i>
//export const bitcoin = <i className="fa-brands fa-bitcoin"></i>
export const cusPayemnt = <i className="fa-brands fa-bitcoin"></i>
