        ...
        <div className="px-5 mt-3">
            ...
            <div className="container">
                ...
                <table className="container table mt-5">
                    <thead>
                        <tr>
                            <th className="center">Donor ID</th>
                            ...
                            <tr key={d._id}>
                                ...
                                <td>
                                    <div className="btn-group">
                                        <Link to={`/donorProfile/${d._id}`} className="btn btn-primary btn-sm me-2">View</Link> {/* Link to DonorProfile.js with donor's _id */}
                                        <Link to={`/updateDonor/${d._id}`} className="btn btn-primary btn-sm me-2">Edit</Link> {/* Link to UpdateDonor.js with donor's _id */}
